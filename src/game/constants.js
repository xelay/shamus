...
export const HUD_H = 32; // single text line: score/level/lives/room/key, tightly packed
...
export const SHOOTER_SPEED_MUL = 0.35; // враг-стрелок (enemy3) двигается намного медленнее обычных врагов
export const SHOOTER_FIRE_MIN = 2.0; // мин. пауза между выстрелами врага-стрелка, сек.
export const SHOOTER_FIRE_MAX = 3.5; // макс. пауза между выстрелами врага-стрелка, сек.
export const ENEMY_SHOT_SPEED = 140; // медленнее SHOT_SPEED игрока — оставляет время увернуться
